...
export const routes: RouteConfig = [
  ...
  route("/registry/@blueprintjs/icons", "./routes/registry+/@blueprintjs.icons[.json].ts"),
  route("/registry/@radix-ui/icons/:name.json", "./routes/registry+/@radix-ui.icons.$name[.json].ts"),
  route("/registry/@radix-ui/icons", "./routes/registry+/@radix-ui.icons[.json].ts"),
  route("/registry/@shadcn.ui/$name.json", "./routes/registry+/@shadcn.ui.$name[.json].ts"),
  route("/registry/@shadcn.ui", "./routes/registry+/@shadcn.ui[.json].ts"),
