...
import { useIsMobile } from "#app/components/hooks/use-mobile.tsx"
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] ease-linear md:flex border-border",
            side === "left"
